<template>
    <div id="macro" class="right-boxcontent">
        <div class="white-box"></div>
        <div class="macro-header">
            <span class="macro-nya-icon"></span>
            <router-link class="macro-close-btn" title="关闭" to="/">
                <span>+</span>
            </router-link>
        ...
        <div class="white-box"></div>
        <div class="macro-text" id="macro">

            <div v-for="item in viewmacro" :key="item.text">
            <MacroBox  :options="options" :bg="item.bg" :title="item.name" :macroCode="item.text" >  </MacroBox>
            </div>
            ...
            this.axios
                ...
                .then((response) => { 
                   ...
                   for (let i = 0; i < length; i++) {
                       ...
                       const macrotext = response.data.data.res[i].text
                       const macroname = response.data.data.res[i].name
                       const macroBoxBg = "macro-box-bg" + ((i)%3)
                       const data = {
                           name:macroname,
                           text:macrotext,
                           bg:macroBoxBg
                        }
                       this.viewmacro.push( data )
